...
export const environment = {
  ...
  apiRLPTopo:
    'https://www.geoportal.rlp.de/mapbender/php/mod_showMetadata.php/../wms.php?',
  apiRLPwfsVerwaltungsgrenzen:
    'https://geo5.service24.rlp.de/wfs/verwaltungsgrenzen_rp.fcgi\\?\\&request\\=GetFeature\\&TYPENAME\\=vermkv:fluren_rlp\\&VERSION\\=1.1.0\\&SERVICE\\=WFS\\&OUTPUTFORMAT\\=GEOJSON',
  apiRLPwfsFlurstuecke:
    'https://geo5.service24.rlp.de/wfs/flurstueckssuche_rp.fcgi?',
